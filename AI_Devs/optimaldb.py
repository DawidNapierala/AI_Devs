...
database = {
    ...
    "stefan": [
        "W ka\u017cd\u0105 \u015brod\u0119 Stefan organizuje konkurs na najd\u0142u\u017cszego zjedzonego hot doga w sklepie \u017babka.",
    ...
    "ania": [
        "Podczas studi\u00f3w prawa, Ania zaanga\u017cowa\u0142a si\u0119 w organizacj\u0119 konferencji dotycz\u0105cej prawa autorskiego.",
...
prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            """
Compress JSON provided by user. The output can be maximum 9000 bytes so store as many informations about persons mentioned in there, but remeber to not exceed the limit. return it as simple text.
            """,
        ),
        ("user", "{input}"),
    ]
...
chain = prompt | model
response = chain.invoke({"input": database})
